        ...
        <div class="col-md-7 col-centered">
          <div class="panel panel-default" id="panel-email">
            <div class="panel-heading" id="panel-heading">
              <h1 class="text-center">Hi {{ $organisasi->nama }}, just one more step! </h1>
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-5 col-sm-5 col-xs-5 col-centered" id="body">
                  <a href="{{ asset('verification/organisasi/'. $organisasi->id_organisasi .'/'. $organisasi->kode_aktivasi)  }}" class="btn btn-success btn-lg">CONFIRM REGISTRATION</a>
                </div>
              </div>
            </div>
