                  ...
                  <div class="tab-pane active" id="general">
                    <div class="panel-group" id="general-faq">
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a href="#penggunaan_akun" data-parent="#general-faq" data-toggle="collapse"
                        ...
                        <div class="panel-collapse collapse in" id="penggunaan_akun">
                          <div class="panel-body">
                            <ul>
                              ...
                              <li>
                                <a href="#">Profile settings, mobile number, address,
                                   email and mobile number preferences</a>
                              </li>
                              <li>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a href="#mencetak_voucher" data-parent="#general-faq" data-toggle="collapse"
                        ...
                        <div class="panel-collapse collapse" id="mencetak_voucher">
                          <div class="panel-body">
                            <ul>
                              <li>After receiving a purchase confirmation email,
                                you will receive an email with a URL to download the voucher.</li>
                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a href="#kehilangan_voucher" data-parent="#general-faq" data-toggle="collapse"
                             class="accordion-toggle collapsed">
                              Lost Voucher
                            </a>
                          </h4>
                        ...
                        <div class="panel-collapse collapse" id="kehilangan_voucher">
                          <div class="panel-body">
                            <ul>
                              <li>If you buy online, you can re-print the voucher.
                                 print another just login to My Account and click on My Voucher</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="panel-collapse collapse in" id="general-protector">
                          <div class="panel-body">
                            ...
                            <address>
                              ...
                              <a href="#" title="Reveal this e-mail address">contact@kepohub.com</a>
                            </address>

                            <iframe style="border: 0;" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJaYfRRgjsaS4RsqOo0WRv64c&key=AIzaSyDc6psDYYWpXUtNMMflCiKLiuya2I9kb6o"
