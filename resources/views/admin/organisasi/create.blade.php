...
@section('content')
  <form class="form-horizontal" action="{{asset('admin/organisasi')}}" method="post">
      ...
      <div class="form-group {{ $errors->has('telp') ? 'has-error' : ''}}">
          ...
          <div class="col-xs-8 col-md-4">
              <input type="text" name="telp" class="form-control" id="telp" aria-describedby="helpBlockTelp" placeholder="Telepon">
      ...
      <div class="form-group {{ $errors->has('alamat') ? 'has-error' : ''}}">
          ...
          <div class="col-xs-8 col-md-4">
              <textarea name="alamat" class="form-control" rows="4" id="alamat" aria-describedby="helpBlockAlamat" placeholder="Alamat"></textarea>
